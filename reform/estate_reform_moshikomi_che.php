		...
		<div class="boxB">
			...
			$moshikomiTel3=$_POST['moshikomiTel3'];
			 ...
			 <p style="font-size:16px;color:red;font-weight:bold;">
				 <td>申込会社：<?php echo $moshikomiCompany; ?>　　</td>
				 <td>申込会社連絡先：
					...
					<div class="photoGallery3">
						<p style="font-size:16px;font-weight:bold;">上記の内容で申込にしますか？</p>
					  <div class="bottomLine">
					    <table>
					      <?php
								print '<form method="post" action="estate_reform_moshikomi_do.php">';
					      print '<input type="hidden" name="code" value="'.$real_code.'">';
								...
								print '<input type="hidden" name="moshikomiTel2" value="'.$moshikomiTel1.'">';
								print '<input type="hidden" name="moshikomiTel3" value="'.$moshikomiTel1.'">';
