	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			try{
				...
				$sql='UPDATE estate SET real_name=?,post1=?,post2=?,address=?,roomNumber=?,yachin=?,kyoeki=?,shiki=?,rei=?,madori=?,madoriType=?,keyLocation=?,email1=?,email2=?,email3=?,email4=?,email5=?,company1=?,company2=?,company3=?,company4=?,company5=?,other=?,timedate=?,keiyaku=?,akiyote=?,moshikomiCompany=?,moshikomiTel1=?,moshikomiTel2=?,moshikomiTel3=?,keiyakusya1=?,keiyaku1Tel1=?,keiyaku1Tel2=?,keiyaku1Tel3=?,hosyonin1=?,hosyonin1Tel1=?,hosyonin1Tel2=?,hosyonin1Tel3=?,akiyoteDay=? WHERE code=?';
			...
			print '<p>【'.$real_name.'　'.$roomNumber.'号室】を空き予定に変更しました。</p>';
			print '<br>';

			print '<p>下記の仲介会社に【'.$real_name.'　'.$roomNumber.'号室】が空き予定である事を連絡をしますか？</p>';
		...
		<form method="post" action="estate_akiyote_connect.php">
			 <table>
			 	<tr>
