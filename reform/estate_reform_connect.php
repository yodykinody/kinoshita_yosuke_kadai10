...
<div class="boxB">
	...
	$owner_email=$rec2['email'];
		...
		$honbun.="\n";
		$honbun.="\n";
		$honbun.=$owner_lastname.''.$owner_firstname.'　様からのリフォーム中物件の連絡です。';
		$honbun.="\n";
		$honbun.="\n";
		...
		$honbun.="\n";
		$honbun.='<h3 style="color:red;">リフォーム完了予定日：'.$reformDay.'</h3>';
		$honbun.="\n";
		$honbun.='「リフォーム内容」';
		$honbun.="\n";
		$honbun.=$reform_naiyo;
		...
		$title='【リフォーム中物件連絡　'.$real_name.'　'.$real_roomNumber.'号室】　'.$real_address.'　'.number_format($real_yachin).'円　'.number_format($real_kyoeki).'円';
