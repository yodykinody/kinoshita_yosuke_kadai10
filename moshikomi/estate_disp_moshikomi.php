	...
	<div class="boxA">
	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			<p style="font-weight:bold;color:red;">申込会社：<?php echo $moshikomiCompany;?>
			...
			<table>
				...
				print '<td><input type="submit" name="keiyaku" value="契約済に変更"></td>';
				print '<td><input type="submit" name="moshikomi_connect" value="申込連絡"></td>';
				print '<td><input type="submit" name="moshikomi_edit" value="情報修正"></td>';
				print '<td><input type="submit" name="moshikomi_cansel" value="申込解除"></td>';
