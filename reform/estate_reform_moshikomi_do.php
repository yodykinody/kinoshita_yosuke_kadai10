	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			try{
				...
				$sql='UPDATE estate SET real_name=?,post1=?,post2=?,address=?,roomNumber=?,yachin=?,kyoeki=?,shiki=?,rei=?,madoriType=?,keyLocation=?,email1=?,email2=?,email3=?,email4=?,email5=?,company1=?,company2=?,company3=?,company4=?,company5=?,other=?,timedate=?,moshikomi=?,moshikomiCompany=?,moshikomiTel1=?,moshikomiTel2=?,moshikomiTel3=?,reformDay=?,reform_naiyo=? WHERE code=?';
		...
		<form method="post" action="estate_reform_moshikomi_connect.php">
			 <table>
			 	<tr>
