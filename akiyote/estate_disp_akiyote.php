	...
	<div class="boxA">
	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			<?php echo $madori; ?>
			<br>
			<p style="font-weight:bold;color:red;">空き予定日：<?php echo $akiyoteDay;  ?></p>
			...
			<table>
				...
				print '<td><input type="submit" name="reform" value="リフォーム中へ" ></td>';
				print '<td><input type="submit" name="akiyote_moshikomi" value="申込登録"></td>';
				print '<td><input type="submit" name="akiyote_connect" value="空き予定連絡"></td>';
				print '<td><input type="submit" name="akiyote_edit" value="情報修正"></td>';
