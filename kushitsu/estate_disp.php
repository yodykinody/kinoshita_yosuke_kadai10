	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			<table>
				...
				print '<td><input type="submit" name="edit" value="情報修正"></td>';
				print '<td><input type="submit" name="moshikomi" value="申込"></td>';
				print '<td><input type="submit" name="kushitsu_connect" value="空室連絡"></td>';
				print '<td><input type="submit" name="other" value="別の部屋を作成"></td>';
				// print '<td><input type="submit" name="edit" value="削除"></td>';
