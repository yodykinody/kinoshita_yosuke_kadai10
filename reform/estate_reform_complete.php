	...
	<div class="boxA">
	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			<form method="post" action="estate_reform_complete_che.php">
			...
			<?php echo $madori; ?>
			<br>
			<p style="font-size:16px;font-weight:bold;color:red;">リフォーム内容に変更がある場合は修正して下さい。</p>
			<p style="font-size:16px;font-weight:bold;">リフォーム完了日：<span class="calender"><input type="text" class="datepicker"  name="reformDay"  style="font-size:20px;height:30px;" value="<?php echo $reformDay; ?>"></span></p>
			<p style="font-size:16px;font-weight:bold;">リフォーム内容：<textarea class="reform_naiyo" name="reform_naiyo" cols="300" placeholder="300字以内で入力して下さい。(未入力だと「クリーニング」の内容になります。)"><?php echo $reform_naiyo; ?></textarea></p>


			<p>仲介会社アドレス（リフォームが完了した事を連絡をします。）</p>
