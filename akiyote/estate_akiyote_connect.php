...
<div class="boxB">
	...
	$owner_email=$rec2['email'];
		...
		$honbun.="\n";
		$honbun.="\n";
		$honbun.=$owner_lastname.''.$owner_firstname.'　様からの空き予定連絡です。';
		$honbun.="\n";
		$honbun.="\n";
		...
		$honbun.="\n";
		$honbun.='<h3 style="color:red;">空き予定日：'.$akiyoteDay.'</h3>';
		...
		$title='【空き予定連絡　'.$real_name.'　'.$real_roomNumber.'号室】　'.$real_address.'　'.number_format($real_yachin).'円　'.number_format($real_kyoeki).'円';
