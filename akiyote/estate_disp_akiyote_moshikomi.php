	...
	<div class="boxA">
	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			<p><?php  echo $other; ?></p>
			<br>
			<p style="font-weight:bold;">空き予定：<?php  echo $akiyoteDay; ?></p>
			...
			<table>
				...
				print '<td><input type="submit" name="akiyote_keiyaku" value="契約済に変更"></td>';
				print '<td><input type="submit" name="akiyote_moshikomi_connect" value="申込連絡"></td>';
				print '<td><input type="submit" name="akiyote_moshikomi_edit" value="情報修正"></td>';
				print '<td><input type="submit" name="akiyote_moshikomi_cansel" value="申込解除"></td>';
