...
$sql='SELECT real_name,post1,post2,address,roomNumber,yachin,kyoeki,shiki,rei,madori,madoriType,keyLocation,email1,email2,email3,email4,email5,company1,company2,company3,company4,company5,other,akiyoteDay FROM estate WHERE code=?';
...
<div class="boxA">
  ...
  <!--//ヘッダーメニュー-->
	...
	<div class="boxB">
		...
		<form method="post" action="estate_akiyote_edit_che.php" enctype="multipart/form-data" id="estate">
			<input type="hidden" name="code" value="<?php print $real_code; ?>">


		<p style="font-size:18px;font-weight:bold;">物件の情報を修正して下さい。</p>
		...
		<p style="font-size:16px;font-weight:bold;">空き予定日：<span class="calender"><input type="text" class="datepicker"  name="akiyoteDay"  style="font-size:20px;height:30px;" value="<?php echo $akiyoteDay; ?>"></span></p>


		<p>仲介会社アドレス（登録したアドレスに空き予定の連絡をします。）</p>
		<table>
			<tr>
