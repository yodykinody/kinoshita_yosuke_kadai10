...
<div class="boxB">
	...
	$owner_email=$rec2['email'];
		...
		$honbun.="\n";
		$honbun.="\n";
		$honbun.=$owner_lastname.''.$owner_firstname.'　様からのリフォーム完了物件の連絡です。';
		$honbun.="\n";
		$honbun.="\n";
		...
		$title='【リフォーム完了物件連絡　'.$real_name.'　'.$real_roomNumber.'号室】　'.$real_address.'　'.number_format($real_yachin).'円　'.number_format($real_kyoeki).'円';
