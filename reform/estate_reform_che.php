	...
	<div class="boxA">
	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			<p style="font-size:25px;font-weight:bold;color:red;text-align:">リフォーム完了日：<?php echo $reformDay; ?>
			</p>
			<table class="reform_table">
				<tr>
					<td style="font-size:20px;font-weight:bold;vertical-align:top;">リフォーム内容：</td><td class="reform_naiyo_span"><?php
			...
			<table>
				...
				print  '<h3>上記の物件をリフォーム中にしますか？</h3>';
				print '<form method="post" action="estate_reform_do.php">';
