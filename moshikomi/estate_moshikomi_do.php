	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			try{
				...
				$sql='UPDATE estate SET real_name=?,post1=?,post2=?,address=?,roomNumber=?,yachin=?,kyoeki=?,shiki=?,rei=?,madori=?,madoriType=?,keyLocation=?,email1=?,email2=?,email3=?,email4=?,email5=?,company1=?,company2=?,company3=?,company4=?,company5=?,other=?,timedate=?,kushitsu=?,moshikomi=?,moshikomiCompany=?,moshikomiTel1=?,moshikomiTel2=?,moshikomiTel3=? WHERE code=?';
				...
				print '<p>【'.$real_name.'　'.$roomNumber.'号室】を申込にしました。</p>';
				print '<br>';
				print '<p>下記の仲介会社に【'.$real_name.'　'.$roomNumber.'号室】が申込になった事を連絡しますか？</p>';
		...
		<form method="post" action="estate_moshikomi_connect_do.php">
			 <table>
			 	<tr>
					...
					print '<input type="hidden" name="timedate" value="'.$timedate.'">';
					 ?>
