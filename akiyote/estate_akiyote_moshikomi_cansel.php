...
<body>
	...
	try
	{
		  ...
		  $dbh->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
			$sql='SELECT real_name,post1,post2,address,roomNumber,yachin,kyoeki,shiki,rei,madori,madoriType,keyLocation,email1,email2,email3,email4,email5,company1,company2,company3,company4,company5,other,akiyoteDay,moshikomiCompany,moshikomiTel1,moshikomiTel2,moshikomiTel3 FROM estate WHERE code=?';
		...
		<div class="boxB">
			...
			<table>
				<tr>
					...
					<td style="font-size:15px;">間取り : <?php echo $madoriType; ?></td>
						...
						<p><?php  echo $other; ?></p>
						<br>
						<p>空き予定日：<?php echo $akiyoteDay; ?></p>
						<p style="color:red;">申込会社：<?php echo $moshikomiCompany;?>
			...
			<div class="photoGallery3">
			  ...
			  <div class="bottomLine">
			    <table>
			      <?php
			      print '<form method="post" action="estate_akiyote_moshikomi_cansel_do.php">';
