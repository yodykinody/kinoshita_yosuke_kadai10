	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			try{
				...
				$sql='UPDATE estate SET real_name=?,post1=?,post2=?,address=?,roomNumber=?,yachin=?,kyoeki=?,shiki=?,rei=?,madori=?,madoriType=?,keyLocation=?,email1=?,email2=?,email3=?,email4=?,email5=?,company1=?,company2=?,company3=?,company4=?,company5=?,other=?,akiyoteDay=?,timedate=?,moshikomi=?,keiyaku=?,moshikomiCompany=?,moshikomiTel1=?,moshikomiTel2=?,moshikomiTel3=?,keiyakusya1=?,keiyaku1Tel1=?,keiyaku1Tel2=?,keiyaku1Tel3=?,hosyonin1=?,hosyonin1Tel1=?,hosyonin1Tel2=?,hosyonin1Tel3=? WHERE code=?';
