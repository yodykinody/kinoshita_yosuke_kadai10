	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			try{
				...
				$sql='UPDATE estate SET real_name=?,post1=?,post2=?,address=?,roomNumber=?,yachin=?,kyoeki=?,shiki=?,rei=?,madoriType=?,keyLocation=?,email1=?,email2=?,email3=?,email4=?,email5=?,company1=?,company2=?,company3=?,company4=?,company5=?,other=?,timedate=?,akiyote=?,reform=?,akiyoteDay=?,reformDay=?,reform_naiyo=? WHERE code=?';
			...
			print '<p>【'.$real_name.'　'.$roomNumber.'号室】をリフォーム中物件に変更しました。</p>';
			print '<br>';

			print '<p>下記の仲介会社に【'.$real_name.'　'.$roomNumber.'号室】がリフォーム中である事を連絡をしますか？</p>';
		...
		<form method="post" action="estate_reform_connect.php">
			 <table>
			 	<tr>
