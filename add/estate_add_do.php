	...
	<div class="boxA">
	  ...
	  <!--//トップ-->
		...
		<div class="boxB">
			...
			$sql='INSERT INTO estate (real_name,post1,post2,address,roomNumber,yachin,kyoeki,shiki,rei,madori,madoriType,keyLocation,email1,email2,email3,email4,email5,company1,company2,company3,company4,company5,other,timedate,kushitsu) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
